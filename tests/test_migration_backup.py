...
assert applied == {"006", "008", "009", "011", "012", "013", "015", "016", "019"}, \
    "008/009/011/012/013/015/016/019 без down() не откатывались — должны остаться применёнными " \
    "(015/016/019 в этом смысле не отличаются от 012: все ALTER'ят или пристраиваются к " \
    "таблице, чей down() уже откатился раньше — 014 для 015/016/019, 007 для 012 — " \
