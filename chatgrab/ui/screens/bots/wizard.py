...
from PySide6.QtWidgets import (
    QComboBox, QDialog, QLabel, QLineEdit, QMessageBox, QRadioButton, QVBoxLayout, QHBoxLayout,
)
...
class BotWizardDialog(QDialog):
    ...
    def _on_confirm(self) -> None:
        ...
        try:
            self.created_bot_id = self.ctx.bot_manager.create_bot(name, type_, token, preset, manager)
